...
class MiniBus(Bus):
    def __init__(self):
        ...
        # Bus.__init__(self, 'Mimi Mini', 'DKA125', 1200000, 50, 450) # when we will call Bus class init then we have to provide self in __init__ method
        # super().sell_ticket('Bappa', 1, 1000) # use Base class method in child class
